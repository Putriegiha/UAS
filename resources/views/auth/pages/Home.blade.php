    ...
    <div class="container-fluid container-xl d-flex align-items-center justify-content-between">
      ...
      <nav id="navbar" class="navbar">
        ...
        <ul>
          ...
          <li><a href="/history" class="pe-2">Riwayat</a></li>
          ...
          <form action="#" class="form-search d-flex align-items-stretch" data-aos="fade-up" data-aos-delay="200">
  ...
  <div id="carouselExample" class="carousel slide">
    <div class="carousel-inner">
      <div class="carousel-item active">
        <img src="https://www.ktown4u.com/goods_files/SH0164/banner_images/003125/BN3124630.default.732.jpg" class="d-block" width="100%" height="600"  alt="...">
      </div>
